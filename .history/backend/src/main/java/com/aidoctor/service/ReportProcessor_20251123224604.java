...
public class ReportProcessor {
    ...
    public MedicalReport process(Map<String, String> fields, String ocrText) {
        ...
        // fields likely contains key->value strings, try to parse numerics if possible:
        ...
        if (testsMap.isEmpty()) {
            // quick regex-based extraction: lines like "Hemoglobin: 11.2 g/dL"
        ...
        // set fields on MedicalReport
        mr.setText(cleanedText);
        mr.setDocType(type.name());
        // convert testsMap -> Map<String, TestResult>
        mr.setTests(testsMap);
        mr.setAiInterpretation(aiJson);
        mr.setSummary(extractSummaryFromAiReply(aiJson)); // small helper defined below
    ...
    private String extractSummaryFromAiReply(String aiReply) {
        ...
        // fallback: return the first 300 chars or "No summary available"
